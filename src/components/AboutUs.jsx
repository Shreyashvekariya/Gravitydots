...
import vishwaImg from '../assets/images/about/team/Vishwa.webp';
import poojaImg from '../assets/images/about/team/Pooja.webp';
import aboutImg from '../assets/images/about/about image.webp';
  ...
  return (
    <div className="about-page-wrapper">
      ...
      <section className="about-hero">
        ...
        <div className="about-single-image-wrapper">
          <img src={aboutImg} alt="About GravityDots" className="about-single-image" />
        </div>
      </section>
      ...
      <section className="who-we-are">
        ...
        <p className="section-description">
          ...
          strategic and performance oriented solutions. We have successfully worked with <strong>182+ clients</strong> across national and international markets, helping businesses establish a strong digital
      ...
      <section className="team-section">
        ...
        <div className="team-grid">
          ...
          <Tilt className="team-member" tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2000} glareEnable={true} glareMaxOpacity={0.1} glareColor="#ffffff" glarePosition="all">
            <div className="team-image-placeholder"><img src={poojaImg} alt="Pooja" /></div>
            <h4 className="team-name">Pooja</h4>
            <p className="team-role">SEO Expert</p>
          </Tilt>
          <Tilt className="team-member" tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.02} transitionSpeed={2000} glareEnable={true} glareMaxOpacity={0.1} glareColor="#ffffff" glarePosition="all">
            <div className="team-image-placeholder"><img src={vishwaImg} alt="Vishwa Dadhaniya" /></div>
            <h4 className="team-name">Vishwa Dadhaniya</h4>
